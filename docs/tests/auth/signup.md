...
- Unsuccessful signup testcases:
    - Pre existing username signup failure
    - Invalid email usage failure
    - Signup with weak passwords should fail
    - Signup with combination of missing fields should fail
